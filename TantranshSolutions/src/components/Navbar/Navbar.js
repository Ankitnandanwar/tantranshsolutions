        ...
        <div className='container'>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto text-center" style={{gap:"1rem", fontSize:"16.5px"}}>
              <li className="nav-item"><Link className="nav-link" style={{color:"#034694", fontWeight:"500"}} to='/'>Home</Link></li>
              <li className="nav-item"><Link className="nav-link" style={{color:"#034694", fontWeight:"500"}} to='/about'>About</Link></li>
              {/* <li><button onClick={()=>{navigate("/about")}}>About</button></li> */}
              {/* <Link to="/about">About</Link> */}
              <li className="nav-item"><Link className="nav-link" style={{color:"#034694", fontWeight:"500"}} to='/carrers'>Careers</Link></li>
